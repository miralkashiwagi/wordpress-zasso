<?php get_header(); ?>
    <main>
        ...
        <section>
            <h2>使い方</h2>
            <p>
                テンプレートファイルの中のHTMLやCSSを変更して、オリジナルのデザインを作りましょう。
            </p>
            <h3>CSSやJavaScript</h3>
            <h4>CSS</h4>
            <p>
                /css/style.css を自由に編集してください。<br>
                /css/reset.css もお好みで変更してください。<br>
                追加のCSSファイルを読み込むときは、functions.phpを確認してください。
            </p>
            <h4>JavaScript</h4>
            <p>
                /js/scripts.js  を自由に編集してください。
            ...
            <h3>プラグイン</h3>
            <p>
                推奨プラグインのインストールメッセージが表示されます。<br>使いたい機能があれば先に入れておきましょう。
            </p>
        </section>
    </main>
<?php get_footer(); ?>